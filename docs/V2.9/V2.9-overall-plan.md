...
V2.9 主发布拆分为 `V2.91` 到 `V2.96` 六个小版本。`V2.97` 作为发布后的 Supermemory / mem0 实际功能追平路线图，继续拆解 connectors、graph、namespace、profile、SDK、多模态和超越项。
...
| `V2.97` | Supermemory / mem0 实际追平路线图 | 基于真实功能差距，规划 connectors、graph、namespace、SDK、多模态和超越项 |
...
| `V2.97` | Supermemory / mem0 实际功能追平 | connectors、Graph Memory、Namespace、Profile / Router / SDK、多模态、超越项 |
...
- [`V2.91-development-plan.md`](./V2.91-development-plan.md)：V2.91 benchmark 基线开发方案
- [`V2.91-compatibility-contract.md`](./V2.91-compatibility-contract.md)：V2.91 老版本和对手功能兼容契约
- [`V2.91-acceptance.md`](./V2.91-acceptance.md)：V2.91 验收口径和报告位置
- [`V2.92-development-plan.md`](./V2.92-development-plan.md)：V2.92 recall trace 与 budget 开发方案
- [`V2.92-acceptance.md`](./V2.92-acceptance.md)：V2.92 验收口径和报告位置
- [`V2.93-development-plan.md`](./V2.93-development-plan.md)：V2.93 secret guard 与 health report 开发方案
- [`V2.93-acceptance.md`](./V2.93-acceptance.md)：V2.93 验收口径和报告位置
- [`V2.9-competitive-feature-checklist.md`](./V2.9-competitive-feature-checklist.md)：超越竞品功能清单与竞品备注
- [`V2.9-v2.97-architecture-map.html`](./V2.9-v2.97-architecture-map.html)：V2.9 到 V2.97 功能、设计和架构总图
- [`V2.97-supermemory-mem0-parity-roadmap.md`](./V2.97-supermemory-mem0-parity-roadmap.md)：按实际功能对比 Supermemory / mem0，并给出最全追平路线图
