...
- 支持 text / image / audio / video 的 evidence locator 统一表达，V2.94 先完成文本、图片和音频 placeholder。
- 提供 provenance query service。
- 提供 passport export / import / verify。
- passport 默认支持 redaction summary 和 manifest hash。
...
- bundle verify 能检查 manifest hash、object count、missing artifact、version compatibility。
- passport import 默认进入 staging / proposal 路径。
