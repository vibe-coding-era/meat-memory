...
- `v2_91-acceptance.sh`：V2.91 benchmark baseline、run / report / compare CLI、报告骨架、V2.7 / V2.8 兼容 smoke 与新增代码 100% 覆盖率说明
...
- `v2_9-production-gate.sh`：V2.9 总生产门禁，覆盖格式、clippy、workspace no-PG 测试、安全专项和 V2.9 总验收；`V2_9_GATE_STRICT=1` 时全量串联子版本验收
...
- `v2_9-production-gate.sh`：V2.9 总生产门禁
