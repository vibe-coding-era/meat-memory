...
- `v2_97-acceptance.sh`：V2.97 connector dry-run、sync-plan、proposal-queue、proposal apply-plan、CLI confirmed executor、conflict review、chat export import draft 和新增代码 100% 覆盖率说明
...
- `v2_97-acceptance.sh`：V2.97 connectors parity、确认式 apply-plan 与 CLI confirmed executor 验收
