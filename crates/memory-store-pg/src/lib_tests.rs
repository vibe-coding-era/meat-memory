use super::{
    ...
    migration_0012_sql, parse_memory_kind, parse_memory_state, parse_sensitivity, parse_visibility,
...
fn v28_sql_helpers_expose_expected_statements() {
    ...
    assert!(migration_0012_sql().contains("evidence_spans"));
    assert!(migration_0012_sql().contains("memory_passport_exports"));
