...
pub use v29_compat::{
    ...
    ConnectorProposalApplyExecutorRequest, ConnectorProposalApplyExecutorResult,
    ConnectorProposalApplyPlanItem, ConnectorProposalApplyPlanReport,
    ConnectorProposalApplyPlanReportPaths, ConnectorProposalApplyPlanRequest,
    ConnectorProposalQueueItem, ConnectorProposalQueueReport, ConnectorProposalQueueReportPaths,
    ConnectorProposalQueueRequest, ConnectorSkeleton, ConnectorSyncPlanDocument,
    ConnectorSyncPlanOutput, ConnectorSyncPlanReport, ConnectorSyncPlanReportPaths,
    ConnectorSyncPlanRequest, MarkdownProjectionCompatibility, V297EncryptedPassportPlan,
    V297GraphPathExplanation, V297MultimodalSurface, V297NamespaceBinding, V297OpsPolicySurface,
    V297ParityCapability, V297ParitySurfaceReport, V297PerfBenchmarkProfile, V297SdkSurface,
    ...
    connector_proposal_confirmation_token, connector_proposal_queue_json, connector_skeletons,
    connector_sync_plan_json, markdown_projection_compatibility, run_connector_dry_run,
    v297_encrypted_passport_plan, v297_graph_path_explanation, v297_namespace_bindings,
    v297_parity_surface_json, v297_parity_surface_report, write_competitor_compatibility_report,
