...
pub use v29_compat::{
    ...
    ConnectorSyncPlanRequest, MarkdownProjectionCompatibility, adapt_mem0_memory_json,
    adapt_memorylake_passport_json, adapt_supermemory_document_json,
    ...
    competitor_capability_mappings, connector_dry_run_json, connector_import_draft_json,
    connector_proposal_queue_json, connector_skeletons, connector_sync_plan_json,
    markdown_projection_compatibility, run_connector_dry_run,
    write_competitor_compatibility_report, write_connector_dry_run_report,
    write_connector_import_draft_report, write_connector_proposal_queue_report,
